...
public class TicTacToeNxNTest {
  ...
  public void testPossibleMovesIntense() {
    try {
      ...
      assertTrue(testNxN.possibleMoves('O').contains(new TicTacToeNxN("Oeeeeeeee")));
      assertTrue(testNxN.possibleMoves('O').contains(new TicTacToeNxN("eOeeeeeee")));
      assertTrue(testNxN.possibleMoves('O').contains(new TicTacToeNxN("eeOeeeeee")));
      assertTrue(testNxN.possibleMoves('O').contains(new TicTacToeNxN("eeeOeeeee")));
      assertTrue(testNxN.possibleMoves('O').contains(new TicTacToeNxN("eeeeOeeee")));
      assertTrue(testNxN.possibleMoves('O').contains(new TicTacToeNxN("eeeeeOeee")));
      assertTrue(testNxN.possibleMoves('O').contains(new TicTacToeNxN("eeeeeeOee")));
      assertTrue(testNxN.possibleMoves('O').contains(new TicTacToeNxN("eeeeeeeOe")));
      assertTrue(testNxN.possibleMoves('O').contains(new TicTacToeNxN("eeeeeeeeO")));
      assertTrue(testNxN.possibleMoves('X').size() == 9);
      assertTrue(testNxN.possibleMoves('X').contains(new TicTacToeNxN("Xeeeeeeee")));
      assertTrue(testNxN.possibleMoves('X').contains(new TicTacToeNxN("eXeeeeeee")));
      assertTrue(testNxN.possibleMoves('X').contains(new TicTacToeNxN("eeXeeeeee")));
      assertTrue(testNxN.possibleMoves('X').contains(new TicTacToeNxN("eeeXeeeee")));
      assertTrue(testNxN.possibleMoves('X').contains(new TicTacToeNxN("eeeeXeeee")));
      assertTrue(testNxN.possibleMoves('X').contains(new TicTacToeNxN("eeeeeXeee")));
      assertTrue(testNxN.possibleMoves('X').contains(new TicTacToeNxN("eeeeeeXee")));
      assertTrue(testNxN.possibleMoves('X').contains(new TicTacToeNxN("eeeeeeeXe")));
      assertTrue(testNxN.possibleMoves('X').contains(new TicTacToeNxN("eeeeeeeeX")));

      testNxN = new TicTacToeNxN("OXeXeOOXe");
      assertTrue(testNxN.possibleMoves('O').size() == 3);
      assertTrue(testNxN.possibleMoves('O').contains(new TicTacToeNxN("OXOXeOOXe")));
      assertTrue(testNxN.possibleMoves('O').contains(new TicTacToeNxN("OXeXOOOXe")));
      assertTrue(testNxN.possibleMoves('O').contains(new TicTacToeNxN("OXeXeOOXO")));
